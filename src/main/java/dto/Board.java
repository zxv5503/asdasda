...
//	}
	...
	public Board(int num, String title, String content, LocalDateTime regtime, int hits, int memberno) {
	    this.num = num;
	    this.title = title;
	    this.content = content;
	...
	public Board(int num, String title, String content, LocalDateTime regtime, int hits) {
		super();
		this.num = num;
		this.title = title;
		this.content = content;
